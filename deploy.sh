...
gcloud functions deploy create_thumbnails --project phaenonet --entry-point create_thumbnail_finalize --runtime python37 --trigger-resource "phaenonet.appspot.com/images/**" --trigger-event google.storage.object.finalize --timeout 540s --region europe-west1
